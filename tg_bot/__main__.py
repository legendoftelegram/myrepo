...
python-telegram-bot library ഉപയോഗിച്ചാണ്.... ഞാൻ പൂർണമായും opensource ആണ്.. എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](http://heroku.com/deploy?template=https://github.com/anandus0070/myrepo) കാണാവുന്നതാണ്...
